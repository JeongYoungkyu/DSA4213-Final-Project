def main():
  ...
  training_args = TrainingArguments(
      output_dir="/tmp/gpt2-small-esconv-lora-3",
  ...
  trainer.train()
  trainer.save_model("/tmp/gpt2-small-esconv-lora-3")
  tokenizer.save_pretrained("/tmp/gpt2-small-esconv-lora-3")

  ADAPTER_DIR = "/tmp/gpt2-small-esconv-lora-3"
  ...
  def chat(user_text, max_new_tokens=25):
    ...
    banned = [
        ...
        "self-harm", "suicid", "kill", "stupid", "crazy", "mentally ill",
        "panic attack"
    ]
